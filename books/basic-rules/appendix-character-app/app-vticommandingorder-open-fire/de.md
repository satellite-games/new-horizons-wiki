# App_VTICommanding_OrderOpenFire

Kameraden erhalten in derselben Kampfrunde eine zusätzliche Schießen-Aktion gegen das markierte Ziel.
...
`SP_TODO: [txt(col=#9F9F9F)]Ausdauerkosten: 2 AP + 1 AP je Empfänger`
