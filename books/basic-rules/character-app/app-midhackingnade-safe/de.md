# App_MIDHacking_NadeSafe

Diese Applikation macht Granaten oder Sprengsätze unschädlich.
...
`SP_TODO: [txt(col=#9F9F9F)]Zielobjekt: Granate oder Sprengsatz mit Fernzünder`
